...
public class TestSerialisableIsNotXmlRoot implements Serializable {

    private String stringVal = "";
    private Integer intVal = 0;
    private Boolean boolVal = false;

    public TestSerialisableIsNotXmlRoot() {
        super();
    }

    public TestSerialisableIsNotXmlRoot(final String stringVal, final Integer intVal, final Boolean boolVal) {
        super();
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof TestSerialisableIsNotXmlRoot)) {
            return false;
        }

        final TestSerialisableIsNotXmlRoot convertObj = (TestSerialisableIsNotXmlRoot) obj;
