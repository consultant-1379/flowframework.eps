...
public final class INTERNAL_SYSTEM_UTILIZATION extends AbstractEvent {
	
	private static final long serialVersionUID = -5392491024393749654L;
	
	private boolean flag;
	private long SCANNER_ID;
	private byte HOUR_ID;
	private byte MIN_ID;
	private byte SECOND_ID;
	private short MILLISEC_ID;
	...
	private long C_ID_2;
	private short RNC_ID_2;
	private long C_ID_3;
	private short RNC_ID_3;
	private long C_ID_4;
	private short RNC_ID_4;
	private long RBS_ID;
	private long LOCAL_CELL_GROUP_ID;
	...
	public INTERNAL_SYSTEM_UTILIZATION() {
		super();
		setRopType(RopType.ROP_RAW);
	}
	...
	public byte getMIN_ID() {
		return MIN_ID;
	}
	public void setMIN_ID(byte mIN_ID) {
		if(flag) {
			throw new RuntimeException();
		}
		MIN_ID = mIN_ID;
	}
	public byte getSECOND_ID() {
		return SECOND_ID;
	}
	public void setSECOND_ID(byte sECOND_ID) {
		SECOND_ID = sECOND_ID;
	}
	public short getMILLISEC_ID() {
		return MILLISEC_ID;
	}
	public void setMILLISEC_ID(short mILLISEC_ID) {
		MILLISEC_ID = mILLISEC_ID;
	}
	...
	public long getC_ID_2() {
		return C_ID_2;
	}
	public void setC_ID_2(long c_ID_2) {
		C_ID_2 = c_ID_2;
	}
	public short getRNC_ID_2() {
		return RNC_ID_2;
	}
	public void setRNC_ID_2(short rNC_ID_2) {
		RNC_ID_2 = rNC_ID_2;
	}
	public long getC_ID_3() {
		return C_ID_3;
	}
	public void setC_ID_3(long c_ID_3) {
		C_ID_3 = c_ID_3;
	}
	public short getRNC_ID_3() {
		return RNC_ID_3;
	}
	public void setRNC_ID_3(short rNC_ID_3) {
		RNC_ID_3 = rNC_ID_3;
	}
	public long getC_ID_4() {
		return C_ID_4;
	}
	public void setC_ID_4(long c_ID_4) {
		C_ID_4 = c_ID_4;
	}
	public short getRNC_ID_4() {
		return RNC_ID_4;
	}
	public void setRNC_ID_4(short rNC_ID_4) {
		RNC_ID_4 = rNC_ID_4;
	}
	...
	public long getLOCAL_CELL_GROUP_ID() {
		return LOCAL_CELL_GROUP_ID;
	}
	public void setLOCAL_CELL_GROUP_ID(long lOCAL_CELL_GROUP_ID) {
		LOCAL_CELL_GROUP_ID = lOCAL_CELL_GROUP_ID;
	}
	...
	public String toString() {
		return "INTERNAL_SYSTEM_UTILIZATION [SCANNER_ID=" + SCANNER_ID
				+ ", HOUR_ID=" + HOUR_ID + ", MIN_ID=" + MIN_ID
				+ ", SECOND_ID=" + SECOND_ID + ", MILLISEC_ID=" + MILLISEC_ID
				+ ", EVENT_ID=" + EVENT_ID + ", UE_CONTEXT=" + UE_CONTEXT
				+ ", RNC_MODULE_ID=" + RNC_MODULE_ID + ", C_ID_1=" + C_ID_1
				+ ", RNC_ID_1=" + RNC_ID_1 + ", C_ID_2=" + C_ID_2
				+ ", RNC_ID_2=" + RNC_ID_2 + ", C_ID_3=" + C_ID_3
				+ ", RNC_ID_3=" + RNC_ID_3 + ", C_ID_4=" + C_ID_4
				+ ", RNC_ID_4=" + RNC_ID_4 + ", RBS_ID=" + RBS_ID
				+ ", LOCAL_CELL_GROUP_ID=" + LOCAL_CELL_GROUP_ID
				+ ", CAPACITY_CREDITS_UL=" + CAPACITY_CREDITS_UL
				+ ", CAPACITY_CREDITS_DL=" + CAPACITY_CREDITS_DL
				+ ", MAX_DL_POWER=" + MAX_DL_POWER + ", CONSUMED_CREDITS_UL="
				+ CONSUMED_CREDITS_UL + ", CONSUMED_CREDITS_DL="
				+ CONSUMED_CREDITS_DL + ", DL_TX_POWER=" + DL_TX_POWER
				+ ", DL_NON_HS_TX_POWER=" + DL_NON_HS_TX_POWER
				+ ", DL_HS_REQ_POWER=" + DL_HS_REQ_POWER + ", UL_INTERFERENCE="
				+ UL_INTERFERENCE + ", TOTAL_ASE_UL=" + TOTAL_ASE_UL
				+ ", TOTAL_ASE_DL=" + TOTAL_ASE_DL
				+ ", TOT_DL_CHAN_CODE_TREE_CONS=" + TOT_DL_CHAN_CODE_TREE_CONS
				+ ", NR_OF_CONNECTIONS_SF8=" + NR_OF_CONNECTIONS_SF8
				+ ", NR_OF_CONNECTIONS_SF16=" + NR_OF_CONNECTIONS_SF16
				+ ", NR_OF_CONNECTIONS_SF32=" + NR_OF_CONNECTIONS_SF32
				+ ", NO_OF_CM_USERS=" + NO_OF_CM_USERS
				+ ", NO_OF_USERS_TO_PHYS_HS_CHAN="
				+ NO_OF_USERS_TO_PHYS_HS_CHAN + ", NO_OF_EDCH_USRS_SERV_CELL="
				+ NO_OF_EDCH_USRS_SERV_CELL + ", NO_EDCH_USRS_NON_SERV_CELL="
				+ NO_EDCH_USRS_NON_SERV_CELL + ", NR_OF_CONNECTIONS_SF4_UL="
				+ NR_OF_CONNECTIONS_SF4_UL + ", NR_OF_CONNECTIONS_SF8_UL="
				+ NR_OF_CONNECTIONS_SF8_UL + ", NR_OF_CONNECTIONS_SF16_UL="
				+ NR_OF_CONNECTIONS_SF16_UL + ", NUMBER_OF_MCCH_MICH="
				+ NUMBER_OF_MCCH_MICH + ", NUMBER_OF_MTCH_64="
				+ NUMBER_OF_MTCH_64 + ", NUMBER_OF_MTCH_128="
				+ NUMBER_OF_MTCH_128 + ", NUMBER_OF_MTCH_256="
				+ NUMBER_OF_MTCH_256 + ", NO_TTI2EDCH_USERS_SERV_CELL="
				+ NO_TTI2EDCH_USERS_SERV_CELL
				+ ", NO_TTI2EDCH_USERS_NON_SERV_CELL="
				+ NO_TTI2EDCH_USERS_NON_SERV_CELL + ", UL_TN_IUB_USAGE="
				+ UL_TN_IUB_USAGE + ", DL_TN_IUB_USAGE=" + DL_TN_IUB_USAGE
				+ ", NR_OF_OPENED_SF256_FOR_FDPCH_SYSTEM_UTIL="
				+ NR_OF_OPENED_SF256_FOR_FDPCH_SYSTEM_UTIL
				+ ", NR_OF_ALLOC_TIMEPOSITIONS_FOR_FDPCH_SYSTEM_UTIL="
				+ NR_OF_ALLOC_TIMEPOSITIONS_FOR_FDPCH_SYSTEM_UTIL
				+ ", EUL_SCHEDULED_RATE=" + EUL_SCHEDULED_RATE
				+ ", NO_OF_CONNECTIONS_SF64_UL=" + NO_OF_CONNECTIONS_SF64_UL
				+ ", NO_OF_CONNECTIONS_SF128_DL=" + NO_OF_CONNECTIONS_SF128_DL
				+ ", DATETIME_ID=" + DATETIME_ID + ", EVENT_TIME=" + EVENT_TIME
				+ "]";
	}
}
