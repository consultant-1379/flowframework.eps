...
public final class TestImkvsLocator implements UnifiedLocator {
	...
	public boolean canLocate(Event source, int rops) {
		return source.getClass().getSimpleName().equalsIgnoreCase(INTERNAL_SYSTEM_UTILIZATION_60MIN.class.getSimpleName());
	}
