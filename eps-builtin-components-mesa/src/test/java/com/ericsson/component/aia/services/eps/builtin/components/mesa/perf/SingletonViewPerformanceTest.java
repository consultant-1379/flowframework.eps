...
public class SingletonViewPerformanceTest extends TestCase {
	...
	public void testSingleton() throws Exception {
		final String text = Util
				.readTextFileFully("src/test/resources/perf/stateless_singleton.py");
			...
			while (true) {
				...
				for (int i = 0; i < 30000; i++) {
					...
					final SingletonView view = new SimpleSingletonView(
							new SimpleId(0), new SimpleId(0), event);
