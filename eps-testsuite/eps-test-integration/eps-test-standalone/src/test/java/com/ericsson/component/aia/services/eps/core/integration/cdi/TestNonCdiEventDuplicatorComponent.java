...
public class TestNonCdiEventDuplicatorComponent extends AbstractEventHandler implements EventInputHandler, Controllable {
    ...
    public void react(final ControlEvent controlEvent) {
        if (controlEvent.getType() == TestCdiControlEventSenderComponent.CONTROL_EVENT_PAUSE_TYPE) {
